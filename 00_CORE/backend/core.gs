 ...
 *  2. Credenciales: configura las Script Properties ADMIN_USUARIO y ADMIN_CLAVE
 *     (Proyecto > Configuracion > Propiedades del script; guia paso a paso en
 *     00_CORE/backend/GUIA_DESPLIEGUE.md). Si no existen, se usan los valores
 *     por defecto de abajo. ROTA la clave: la actual estuvo en el repositorio.
...
// Fuente oficial: Script Properties del proyecto (ADMIN_USUARIO / ADMIN_CLAVE).
// Fallback: los valores por defecto de abajo, para que el login siga
// funcionando aunque las propiedades no esten configuradas. Configurarlas y
// rotar la clave es OBLIGATORIO tras el expose en el repo (guia en
// 00_CORE/backend/GUIA_DESPLIEGUE.md).
var ADMIN_USUARIO_DEFAULT = 'Adis';
var ADMIN_CLAVE_DEFAULT   = 'Adisdiseño2026';
var ADMIN_USUARIO = PropertiesService.getScriptProperties().getProperty('ADMIN_USUARIO') || ADMIN_USUARIO_DEFAULT;
var ADMIN_CLAVE   = PropertiesService.getScriptProperties().getProperty('ADMIN_CLAVE')   || ADMIN_CLAVE_DEFAULT;
// ================================================================================

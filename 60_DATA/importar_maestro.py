# -*- coding: utf-8 -*-
"""[OBSOLETO desde P1, 2026-09-13] Flujo historico hoja <- repo.

La direccion oficial ahora es hoja -> repo via 60_DATA/exportar_productos.py
y la puerta de drift 60_DATA/verificar_fuentes.py (ver
00_CORE/config/FUENTES_DE_PRODUCTOS.md). Este script solo se conserva como
referencia del formato de importacion; NO ejecutar contra produccion.
...
dataset = json.load(open(BASE / '60_DATA' / 'dataset_maestro.json', encoding='utf-8'))
